package com.zaid.zaidpickmeproj.adapter;
...
//    }
    ...
    private void setAlignment(ViewHolder holder, boolean isMe) {
        if (!isMe) {
            ...
            holder.contentWithBG.setBackgroundResource(R.drawable.border_tv_chat_in);
    ...
    private ViewHolder createViewHolder(View v) {
        ...
        holder.maindate = v.findViewById(R.id.messagegroupdate_tv);
        return holder;
    }
